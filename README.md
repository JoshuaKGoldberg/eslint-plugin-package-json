...
| [sort-collections](docs/rules/sort-collections.md)                         | Selected package.json collections must be in a consistent order (lexical for most; lifecycle-aware for scripts). | ✔️ ✅ | 🔧 |    |    |
