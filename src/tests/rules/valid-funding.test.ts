...
`,
			errors: [
				{
					data: {
						error: "the value should be an object with `type` and `url`, a string, or an Array of the two",
					},
					line: 2,
...
`,
			errors: [
				{
					data: {
						error: "unexpected property `email`; only `type` and `url` are allowed in a funding object",
					},
					line: 4,
					messageId: "validationError",
				},
